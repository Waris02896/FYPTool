...
import StudentBoard from "../../Component/Profiles Boards/Student_Board.component";
import Card_Edits from "../../Component/Card_Edits/Card_Edits";

function StudentBoards_Display() {
        ...
        <div className="app">
            ...
            <div className="app_container">
                <div className="app_boards">
                    {
                        boards.map((item) => (
                            <StudentBoard key={item.id} board={item}
...
export default StudentBoards_Display;